...
<div class="row">
    ...
    <div class='col-md-6 setup-body well'>
        ...
        <form class='setup-form' method='POST' action='/setup'>
            ...
            <p>
                Database Name:
                <button data-content="Name of existing database. You must create the Polr database manually."
            ...
            <p>
                Redirect URL:
                <button data-content="Required if you wish to redirect the index page or 404s to a different website. To use Polr, login by directly heading to yoursite.com/login first."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                ...
                <button data-content="If you choose to use pseudorandom strings, you will not have the option to use a counter-based ending."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                URL Ending Base:
                <button data-content="This will have no effect if you choose to use pseudorandom endings."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <h4>
                ...
                <button data-content="These credentials will be used for your admin account in Polr."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </h4>
            ...
            <h4>
                SMTP Settings
                <button data-content="Required only if the email verification or password recovery features are enabled."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </h4>
            ...
            <p>
                Anonymous API Quota:
                <button data-content="API quota for non-authenticated users per minute per IP."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                Registration:
                <button data-content="Enabling registration allows any user to create an account."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                ...
                <button data-content="Restrict registration to certain email domains."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                ...
                <button data-content="A comma-separated list of emails permitted to register."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                Password Recovery:
                <button data-content="Password recovery allows users to reset their password through email."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                ...
                <button data-content="You must provide your reCAPTCHA keys to use this feature."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
            ...
            <p>
                ...
                <button data-content="You must provide reCAPTCHA keys if you intend to use any reCAPTCHA-dependent features."
                    type="button" class="btn btn-xs btn-default setup-qmark" data-toggle="popover">?</button>
            </p>
